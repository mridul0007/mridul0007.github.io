...
class CombinedMap extends HTMLElement {
    constructor() {
        ...
        this.default_map = ""
        this.mapType = 'google';
        this.google_mapsjs_api_key = 'AIzaSyB6s10ZXj5wjnbIRG92nB0TnANeKzxkDHc';
    ...
    async set_coordinate_master_data(SAC_COORDINATE_DATA,flag) {
        ...
        if (this.dataSource === 'sac' && flag === false) {
...
customElements.define('com-example-mapszip', CombinedMap);
})();