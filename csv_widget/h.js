...
(function () {
  ...
  class MasterData_Maintain extends HTMLElement {
    ...
    init() {
      ...
      let csvData = [];
      let columnNames = [];
      let df, mem_id, mem_description, mem_properties, mem_hierarchies = [];
          ...
          if (target.classList.contains('drop-zone')) {
            ...
            switch (dropTarget) {
              ...
              case 'Description':
                ...
                break;
              case 'Hierarchy':
                mem_hierarchies.push(columnName);
                break;
              case 'Properties':
                mem_properties.push(columnName);
                break;
              // Add cases for other drop zones as needed
            }
            ...
            console.log(mem_id);
            console.log(mem_description);
            console.log(mem_hierarchies);
            console.log(mem_properties);
          }
        });
      });
